...
export class BookingController {
  ...
  async createNewBooking(
    ...
    const bookingData: IBooking = {
      trip_id: new Types.ObjectId(createBookingDto.trip_id),
      booking_id: 0, // Will be auto-generated by pre-save hook
      seats: createBookingDto.seats,
      passenger_name: createBookingDto.passenger_name,
      passenger_nic: createBookingDto.passenger_nic,
      pick_up_location: createBookingDto.pick_up_location,
      drop_off_location: createBookingDto.drop_off_location,
      contact_no: createBookingDto.contact_no,
      email: createBookingDto.email,
      guardian_contact_no: createBookingDto.guardian_contact_no,
      special_instruction: createBookingDto.special_instruction,
      is_active: createBookingDto.is_active ?? true,
  ...
  async cancelBooking(
    ...
    //   const updatedBooking = await this.bookingService.updateDocument({
    //     _id: new Types.ObjectId(pathParams.id),
    //     is_active: false,
    //     changed_by: loggedUser._id,
    //   });
    //   if (!updatedBooking)
  ...
  async deleteBooking(
    ...
    const deletedBooking = await this.bookingService.hardDelete(pathParams.id);
